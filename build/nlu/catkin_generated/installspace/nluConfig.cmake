...
if("FALSE" STREQUAL "TRUE")
  set(nlu_SOURCE_PREFIX /home/hntea/RobotWorkSpace/SpeechSystem/speech_system/src/nlu)
  set(nlu_DEVEL_PREFIX /home/hntea/RobotWorkSpace/SpeechSystem/speech_system/devel)
  set(nlu_INSTALL_PREFIX "")
  set(nlu_PREFIX ${nlu_DEVEL_PREFIX})
else()
  set(nlu_SOURCE_PREFIX "")
  set(nlu_DEVEL_PREFIX "")
  set(nlu_INSTALL_PREFIX /home/hntea/RobotWorkSpace/SpeechSystem/speech_system/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nlu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'hntea <hntea@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'nlu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hntea/RobotWorkSpace/SpeechSystem/speech_system/install/${idir}'.  Ask the maintainer 'hntea <hntea@todo.todo>' to fix it.")
    endif()
